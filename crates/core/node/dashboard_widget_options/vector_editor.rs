...
pub struct DashboardNodeWidgetVec2EditorOptionsNode {}

#[node("dashboard_node_widget_vec2_editor_options", from_struct)]
impl Node for DashboardNodeWidgetVec2EditorOptionsNode {
