...
use super::ui_server::{run_with_ui_server_config, UiServerConfig};
use crate::app::{create_new_project_engine, ProjectLifecycle};
...
fn run_tauri<R: Runtime>(ui_base_url: &str, tauri_context: tauri::Context<R>) -> std::io::Result<()> {
    ...
    tauri::Builder::<R>::new()
        ...
        .invoke_handler(tauri::generate_handler![
            super::desktop_commands::window_minimize,
            super::desktop_commands::window_toggle_maximize,
            super::desktop_commands::window_close,
            super::desktop_commands::window_is_maximized,
            super::desktop_commands::start_drag,
            super::desktop_commands::open_file_dialog,
            super::desktop_commands::save_file_dialog
        ])
