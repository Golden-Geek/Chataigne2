...
/// Built-in child `decl_id` for a multiplex's one-based default preview index.
pub const USER_CONTEXT_MULTIPLEX_DEFAULT_PREVIEW_INDEX_DECL_ID: &str = "default_preview_index";
