#!/usr/bin/env python3
"""Generate the deterministic Phase 9 full-workbench graph scale fixture."""
...
CONTRACT = "chataigne-phase9-graph-fixture-v1"
DEFAULT_GRAPH_NODE_COUNT = 10_000
DEFAULT_SOURCE = Path("apps/chataigne/test-samples/test_simple_load.noisette")
