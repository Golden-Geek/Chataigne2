...
enum FormulaOrigin {
    /// Bundled with the app, read-only, loaded from `resources/formulas/builtin/`.
    Builtin,
...
impl FormulaCatalog {
    ...
    /// nodes (see `systems_alchemist_formula::external_formula_tree_for_path`)
...
/// (see `systems_alchemist_formula::external_formula_tree_for_path`); its
