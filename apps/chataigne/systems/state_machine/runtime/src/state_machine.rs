...
use chataigne_state_machine_model::{LifecycleEvent, StateId, Statechart, TransitionId, TransitionOutcome};
...
impl ChataigneStateMachineRuntime {
    ...
    ) -> Result<(), chataigne_state_machine_model::StatechartError> {
    ...
    pub fn tick(
        ...
        machine: &mut ChataigneStateMachine,
        ctx: &EvaluationCtx<'_>,
    ) -> Result<StateMachineTickOutput, chataigne_state_machine_model::StatechartError> {
