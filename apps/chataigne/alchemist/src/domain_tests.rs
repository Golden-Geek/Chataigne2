...
fn representative_document() -> (AlchemistGraphDocument, AlchemistGraphId, crate::ANodeId) {
    ...
    let mut document = AlchemistGraphDomain::new_document_with_identity(graph_id, "Phase 4 typed fixture");
...
fn typed_alchemist_document_uses_common_graph_contract() {
    ...
    assert_eq!(document.data().metadata.label, "Phase 4 typed fixture");
