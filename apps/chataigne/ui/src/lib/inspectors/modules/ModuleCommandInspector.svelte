<script lang="ts">
	...
	import CheckboxEditor from 'golden_ui/components/panels/inspector/parameters/CheckboxEditor.svelte';
	import TriggerEditor from 'golden_ui/components/panels/inspector/parameters/TriggerEditor.svelte';
