...
/**
 * Converts list-backed product graph projections into a revisioned presentation document.
 * Every plane advances conservatively because these projections do not expose partitioned
 * revisions. The adapter has no command, trigger, effect, or device authority.
 */
export class GraphDocumentAdapter {
