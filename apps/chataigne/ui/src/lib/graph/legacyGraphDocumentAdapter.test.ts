...
import { LegacyGraphDocumentAdapter } from './legacyGraphDocumentAdapter';
...
describe('LegacyGraphDocumentAdapter', () => {
	it('keeps a stable document until a legacy array identity changes', () => {
		const adapter = new LegacyGraphDocumentAdapter();
