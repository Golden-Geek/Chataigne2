...
`golden_ui` is the canonical reusable UI package boundary under `packages/golden-ui/`.

## Ownership Rules

- `apps/chataigne/ui/src/routes/` is the app UI shell.
- `apps/chataigne/ui/src/lib/assets/` is app-owned branding/assets.
- `packages/golden-ui/` owns reusable UI logic and package-local docs.
...
4. Keep app-specific registration and branding out of this now-independent package.
