import type { GraphRevision } from "./generated/GraphRevision";
...
/** A domain-adapted graph view keyed by the Rust-owned graph revision planes. */
export interface GraphPresentationDocument {
