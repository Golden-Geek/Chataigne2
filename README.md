...
- `golden_model` owns stable cross-layer identities, and `golden_values` owns the canonical runtime
  value model and conversions used by parameters, Alchemist, statecharts, persistence, and UI DTOs.
...
[Foundation Ownership](docs/architecture/foundations.md) describes the Phase 3 identity and value
cutovers that graph packages build upon.
