...
- `packages/golden-statechart-ui` owns the app-neutral statechart projection.
- `apps/chataigne/ui/src/lib/state_machine` owns Formula and Processor presentation.
