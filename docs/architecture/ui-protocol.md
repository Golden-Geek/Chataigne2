...
- `crates/golden_core/engine/src/ui_sync.rs` applies intents and projects engine state into those
  canonical DTOs. It is an adapter, not a second protocol declaration site.
